...
const routes = [
    {
        ...
        children: [
            {
                path: 'editor',
                loadChildren: () => __webpack_require__.e(/*! import() | editor-editor-module */ "editor-editor-module").then(__webpack_require__.bind(null, /*! ./editor/editor.module */ "./src/app/editor/editor.module.ts")).then((m) => m.EditorModule),
            },
            {
                path: '',
                pathMatch: 'full',
...
module.exports = __webpack_require__(/*! E:\person\report-editor\src\main.ts */"./src/main.ts");
